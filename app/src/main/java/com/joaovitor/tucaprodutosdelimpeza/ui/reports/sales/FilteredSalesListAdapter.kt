...
class FilteredSalesListAdapter(val clickListener: SaleListAdapter.SaleListener) :
    ListAdapter<Sale, FilteredSalesListAdapter.ViewHolder>(FilteredSaleDiffCallback()){
